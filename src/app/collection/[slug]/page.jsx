          ...
          <div className="row">
            <div className="col-lg-12">
              ...
              <div className="mobile-filter-sort">
                <span className="mfs-btn" onClick={handleToggleShow}>Filter and sort</span>
              </div>

              <div className={showActive ? 'mobile-filter-blk ' : ' active mobile-filter-blk'}>
              ...
              <div className={isActive ? "filter-product-blk " : "active filter-product-blk "}>
                <div className="filter-left">
                    <Filter products={category?.products?.data} setFilteredProducts={setFilteredProducts}/>
                </div>
