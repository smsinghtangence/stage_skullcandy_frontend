...
function page({params}) {   
  ...
  console.log("slug " + params.category)  /////
  const [category, setCategory] = useState(); 
  const getdata = async () =>{    
    const response = await getDataWithQuery(`/api/product-categories?filters[slug][$eq]=${slug}&populate[1]=parent_category,products&populate[2]=products.image`,
                ...
                <div className="product-right">
                  ...
                  <div className="pr-list">
                    <Link href="/products/a">
                      <ProductList  slug={slug} key={slug}/>
                      <div className="pr-list-hover-info">
                        <img src="https://www.skullcandy.com/cdn/shop/files/crusher_evo_buy_box_true_black_5_78d21493-6c35-4730-a997-36acf2bccd84.png?format=pjpg&v=1709753000&width=1500" alt="" />
                        <div className="pr-list-hover-content">
                          <h4>SHOP Crusher <sup>®</sup>Evo <i className='fa fa-chevron-right'></i></h4>
                          <div className="stars">
