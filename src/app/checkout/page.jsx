...
function Page() {
  ...
  const { isLoading, isPaymentWithCard, shipping, address, checkoutUserType } =
            ...
            <div className="col-lg-7">
              ...
              {!users?.id && (
                ...
                <div className="payment">
                  <div
                    className="accordion"
                    id="accordionWithRadioExample_PreChecked"
                  >
                ...
                {/* <div className="billing-address">
                  ...
                  <div className="accordion" id="billing-address">
                    <div className="card">
                      <div className="card-header">
                        <div className="custom-control custom-radio">
                          <input
                            ...
                            data-target="#collapseOne_billing_adress"
                            type="radio"
                            id="customRadio1_billing_adress"
                            name="billing-address"
                            className="custom-control-input"
                          />
                          <label
                            className="custom-control-label"
                            for="customRadio1_billing_adress"
                          >
                            {" "}
                      ...
                      <div
                        id="collapseOne_billing_adress1"
                        className="collapse "
                        data-parent="#billing-address"
                      >
                    ...
                    <div className="card">
                      <div className="card-header">
                        <div className="custom-control custom-radio">
                          <input
                            data-toggle="collapse"
                            data-target="#collapseTwo_billing_adress"
                            type="radio"
                            id="customRadio2_billing_adress"
                            name="billing-address"
                            className="custom-control-input"
                          />
                          <label
                            className="custom-control-label"
                            for="customRadio2_billing_adress"
                          >
