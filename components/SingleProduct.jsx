...
function SingleProduct({ product }) {
  ...
  const { users, isSuccess: isuserSuccess } = useSelector(
    (state) => state.auth
  );
  ...
  const {
    ...
    isSuccess,
    isBuyNow,
    isLoading: CartWishLoading,
  } = useSelector((state) => state.cartWish);
  ...
  const [activeSlide, setActiveSlide] = useState(
    product?.Variation_Sliders ? product?.Variation_Sliders[0] : ""
  );
  ...
  // ////////
  const productColorImgList = document.querySelectorAll(
        ...
        <div className="container">
          <div className="row">
            ...
            <div className="col-lg-5">
              <div className="single-product-content">
                <p className="product-text">
                  {product?.Product_Tag_Line_Heading}
                </p>
                <h1 className="sp-heading">{product?.title}</h1>

                <div className="sp-price">
                  <span>
                    {activeSlide?.Variations_Price && (
                      <i className="fa fa-rupee"></i>
                    )}
                    {activeSlide?.Sales_price
                      ? activeSlide?.Sales_price
                      : activeSlide?.Variations_Price}
                  </span>
                  {/* price */}
               ...
               <svg aria-hidden="true" xmlns="http://www.w3.org/2000/svg" className="shop-pay-logo" viewBox="0 0 341 81" fill="none">
                ...
                <div className="sp-start-blk">
                  ...
                  <div className="review-summary">
                    ...
                    >
                      <path
                        d="M12.616 0L13.6143 1.94771L15.4861 2.9865L13.6143 4.02527L12.616 5.97298L11.6177 4.02527L9.74584 2.9865L11.6177 1.94771L12.616 0ZM5.80334 2.4614L7.82189 6.39963L11.6067 8.50004L7.82189 10.6004L5.80334 14.5386L3.78479 10.6004L0 8.50004L3.78479 6.39963L5.80334 2.4614ZM14.6345 11.9131L13.373 9.45175L12.1113 11.9131L9.74584 13.2259L12.1113 14.5386L13.373 17L14.6345 14.5386L17 13.2259L14.6345 11.9131Z"
                        fill="#FFC700"
                      ></path>
                    </svg>
                    <Link href="#">See Reviews Summary </Link>
                  </div>
                </div>
                  ...
                  <div className="product-color-img-blk-variant">
                    ...
                    {product?.Variation_Sliders?.map((slide, pindex) => {
                      return (
                        <div
                          key={pindex}
                          className="product-color-img-list"
            ...
            SOLD OUT</Link> */}
                ...
                {activeSlide?.Quantity == null || activeSlide?.Quantity == 0 ? (
                  <>
                    <button
                      type="button"
                      class="btn btn-primary w-100 notify-btn"
                      data-toggle="modal"
                    ...
                    {CartWishLoading == true ? (
                      ...
                      <>
                          ...
                          onClick={(e) => {
                            ...
                            if (!cartItems?.includes(activeSlide?.SKU)) {
                              handleCart(e, {
                                ...
                                Variant_Image_url: geturl(
                                  activeSlide?.Variant_Image
                                ),
                        ...
                        >
                          ...
                          {cartItems?.includes(activeSlide?.SKU)
                            ? "Added"
                            : "Add to Cart"}
                        </button>
                      </>
                      ...
                      <div className="sp-container">
                        <div className="sp-wrapper">
                          {product?.Product_Usp?.map((item, i) => (
                            <div key={item.id} className="sp-row sp-row-one">
          ...
          <div className="modal-content">
            ...
            <div className="modal-body">
              ...
              <form action="">
                ...
                <div className="form-group">
                  <Link href="#" className="product-available-btn">
                    Notify me when available
                  </Link>
                </div>
