               ...
               <div className="review-list-panel">
                  <div className="rlp-left">
                     <div className="rlp-left-blk">
                        ...
                        <div className="user-content">
                           <span className="rlp-user-name">Javier</span>
                  ...
                  <div className="rlp-center">
                     <div className="rlp-center-blk">
                        ...
                        <span className="rpl-text">5 star rating i really like the bass and how it fits. the price was also really good</span>
                     </div>
                  </div>
