            ...
            <div className="footer-block  ">
              <div className="footer-block__details-content">
                ...
                <ul className="list-unstyled list-social footer__list-social" role="list"><li className="list-social__item">
                  <Link target="_blank" href="https://www.tiktok.com/@skullcandy" className="link list-social__link" aria-label="https://www.tiktok.com/@skullcandy"><svg className="icon icon-tiktok" xmlns="http://www.w3.org/2000/svg" xmlnsXlink="http://www.w3.org/1999/xlink" version="1.1" width={256} height={256} viewBox="0 0 256 256" xmlSpace="preserve">
                    <defs>
                    </defs>
                    ...
                    <Link target="_blank" href="https://www.instagram.com/skullcandy" className="link list-social__link" aria-label="https://www.instagram.com/skullcandy"><svg aria-hidden="true" focusable="false" className="icon icon-instagram" viewBox="0 0 18 18">
                  ...
                  <li className="list-social__item">
                    <Link target="_blank" href="https://www.youtube.com/@Skullcandy" className="link list-social__link" aria-label="https://www.youtube.com/@Skullcandy"><svg aria-hidden="true" focusable="false" className="icon icon-youtube" viewBox="0 0 100 70">
                  ...
                  <li className="list-social__item">
                    <Link target="_blank" href="https://twitter.com/skullcandy" className="link list-social__link" aria-label="https://twitter.com/skullcandy">
            ...
            <div className="footer-block grid__item  footer-block--menu">
              <ul className="footer-block__details-content list-unstyled">
                ...
                <li>
                  ...
                  <Link href="/orderlookup" className="link link--text list-menu__item list-menu__item--link">
                    Order Tracking
                  </Link>
                </li></ul></div>
                <div className="footer-block grid__item  footer-block--menu"><ul className="footer-block__details-content list-unstyled"><li>
                  <Link href="/pages/join-us" className="link link--text list-menu__item list-menu__item--link" aria-label="/pages/join-us">
                    About
                  </Link>
                </li><li>
                    <Link href="/pages/music-with-a-mission" className="link link--text list-menu__item list-menu__item--link" aria-label="/pages/music-with-a-mission">
                    ...
                    <Link href="/press-releases" className="link link--text list-menu__item list-menu__item--link" aria-label="/press-releases">
                      Press Releases
                    </Link>
                  </li><li>
                    <Link href="/contact-us" className="link link--text list-menu__item list-menu__item--link" >
                      Contact Us
                    </Link>
                  </li>
                  </ul>
